...
if (isset($_GET['delete']) && !empty($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM koht WHERE id = $delete_id";
    mysqli_query($yhendus, $delete_query);
    // Võib lisada ka kinnitamise teate või suunata mujale
}

// Muutmine
if (isset($_GET['edit']) && !empty($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    // Siin võib juurde lisada edasise töötlemise vastavalt vajadusele
}
    ...
    <table class="table">
        ...
        <tbody>
            ...
            while ($rida = mysqli_fetch_assoc($vastus)){
                ...
                echo '<td><a href="muuda.php?id='.$rida['id'].'">Muuda</a> | <a href="kustuta.php?id='.$rida['id'].'">Kustuta</a></td>';
